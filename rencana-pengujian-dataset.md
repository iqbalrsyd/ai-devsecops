...
- Arsitektur: monolitik tradisional saja (single deployable app, semua layer dalam satu proses). Klasifikasi internal sistem tetap mendukung modular_monolith untuk generalisasi, namun dataset eksperimen Bab 4 hanya monolitik. Arsitektur bukan variabel eksperimen utama.
...
- Independen: teknologi, arsitektur (monolitik), deployment target, domain webapp.
...
- Arsitektur monolitik (homogen, tidak divariasikan) sehingga tidak menjadi variabel yang dikontrol secara statistik.
