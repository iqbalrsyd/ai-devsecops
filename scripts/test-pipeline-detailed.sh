...
RESP=$(docker run --rm --network ai-devsecops_appnet curlimages/curl:latest \
    ...
    -d '{"repository_id":"00000000-0000-0000-0000-000000000001","repository_full_name":"octocat/Hello-World","github_token":"","query":"basic CI","language":"python","framework":"","deploy_target":"docker","project_type":"api","security_requirements":[]}' 2>&1)
